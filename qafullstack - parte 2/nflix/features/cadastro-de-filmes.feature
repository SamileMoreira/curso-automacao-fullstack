#language:pt
@login 
#pra ele sempre fazer login, está configurado com o login page dentro do hooks/
Funcionalidade: Cadastro de filmes
    ...
    @dup_movie
    Cenario: Duplicado
        O gestor de catálogo tenta cadastrar um filme, porém o tétulo 
        já foi cadastrado em outro momento e o sistema notifica o usuário
        informando que esse título já existe
       
        Dado que "deadpool2" é um novo filme
        Mas esse filme já existe no catálogo
        Quando eu faço o cadastro deste filme
